                ...
                <div class="site-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        if( have_posts() ):  the_post();
                            ...
                            $enable_fp = Pisces()->settings->get_post_meta(get_the_ID(), 'enable_fp');

                            if(Pisces()->layout->get_site_layout() == 'col-1c' && ($enable_fp == 'yes' || $enable_fp == 'on')){
                                $fp_section_effect = Pisces()->settings->get_post_meta(get_the_ID(), 'fp_section_effect');
