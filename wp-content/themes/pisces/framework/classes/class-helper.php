...
if(!class_exists('Pisces_Helper')){
    ...
    class Pisces_Helper{
        ...
        public static function get_base_shop_url(){
            ...
            elseif( is_tax('product_tag') || is_tax('product_cat') ){
            ...
            switch($type){
                case 'dropdown_menu':
                    ...
                    if(!empty($component['text'])){
                        ...
                        $icon_html .= esc_html($component['text']);
                        $icon_html .= '</span>';
                    }
                ...
                case 'primary_menu':
                    ...
                    $icon_html = '<svg class="dlicon-menu2" width="100%" height="100%"><use xlink:href="#dlicon-menu2"></use></svg>';
                    $target_html = '<a rel="nofollow" class="component-target" href="javascript:;">'.$icon_html.'</a>';
                    break;
                ...
                case 'text':
                    ...
                    if(!empty($component['text'])){
                        ...
                        $target_html .= esc_html($component['text']);
                        $target_html .= '</span>';
                        $target_html .= '</span>';
                    }
                    else{
                ...
                case 'link_text':
                    ...
                    if(!empty($component['text'])){
                        $icon_html .= '<span class="component-target-text">'.esc_html($component['text']).'</span>';
                    }
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'search_1':
                    ...
                    $icon_html = '<i class="fa fa-search"></i>';
                ...
                case 'cart':
                    ...
                    $icon_html = '<i class="pisces-icon-cart-modern"></i><span class="component-target-badget la-cart-count">'.$cart_count.'</span>';
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'wishlist':
                    ...
                    $icon_html = '<i class="pisces-icon-favourite2"></i><span class="component-target-badget la-wishlist-count">-</span>';
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'compare':
                    ...
                    $target_url = isset($component['link']) ? $component['link'] : '#';
                    $icon_html = '<i class="pisces-icon-loop-alt3"></i><span class="component-target-badget la-wishlist-count">-</span>';
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'aside_header':
                    ...
                    $icon_html      = '<i class="'.(!empty($component['icon']) ? $component['icon'] : 'pisces-icon-menu').'"></i>';
                    $target_html = '<a rel="nofollow" class="component-target" href="javascript:;">'.$icon_html.'</a>';
                    break;
                ...
                case 'burger_menu':
                    ...
                    $icon_html      = '<i class="'.(!empty($component['icon']) ? $component['icon'] : 'pisces-icon-menu2').'"></i>';
                    $target_html = '<a rel="nofollow" class="component-target" href="javascript:;">'.$icon_html.'</a>';
                    break;
            }
