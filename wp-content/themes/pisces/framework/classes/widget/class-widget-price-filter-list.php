...
class Pisces_Widget_Price_Filter_List extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			...
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'pisces' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'la-price-filter-list', esc_html__( '[Pisces] - Price Filter List', 'pisces' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$base_shop_url = Pisces_Helper::get_base_shop_url();
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'pisces' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Content:', 'pisces' ); ?></label>
		...
		<p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'pisces' ); ?></p>
		<p><?php esc_html_e( '100|200', 'pisces' ); ?><br><?php esc_html_e( '200|300', 'pisces' ); ?>
			<br><?php esc_html_e( '300|400', 'pisces' ); ?></p>
		<?php
	}
}
