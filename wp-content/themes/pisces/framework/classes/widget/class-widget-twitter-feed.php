...
class Pisces_Widget_Twitter_Feed extends WP_Widget {

    public function __construct(){
        parent::__construct(
            'twitter_feed',
            esc_html__('[Pisces] - Twitter Feed', 'pisces'),
            array(
                'description' => esc_html__('Display Twitter Feed', 'pisces')
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'screen_name' ) ); ?>"><?php esc_attr_e( 'Screen Name:', 'pisces' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_attr_e( 'Number Feed:', 'pisces' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'enable_slider' ) ); ?>"><?php esc_attr_e( 'Enable Slider:', 'pisces' ); ?></label>
        </p>
        <?php
    }
