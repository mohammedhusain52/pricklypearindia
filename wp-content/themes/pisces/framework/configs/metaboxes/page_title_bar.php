 ...
 * @return array
 */
function pisces_metaboxes_section_page_title_bar( $sections ) {
    ...
    $sections['page_title_bar'] = array(
        ...
        'fields'        => array(
            array(
                ...
                'desc'          => esc_html_x('Choose to show or hide the page title bar.', 'admin-view', 'pisces'),
                'options'       => Pisces_Options::get_config_page_title_bar_opts(false,true)
            ),
            array(
                'id'            => 'hide_breadcrumb',
                'type'          => 'radio',
                ...
                'title'         => esc_html_x('Hide Breadcrumbs', 'admin-view', 'pisces'),
            ...
            array(
                ...
                'default'       => 'no',
                'class'         => 'la-radio-style',
                'title'         => esc_html_x('Hide Page Title', 'admin-view', 'pisces'),
                'options'       => Pisces_Options::get_config_radio_opts(false),
                'dependency'    => array( 'page_title_bar_layout', '!=', 'hide' )
            ),
            array(
                ...
                'type'          => 'text',
                'title'         => esc_html_x('Page Title Bar Custom','admin-view', 'pisces'),
            ...
            array(
                ...
                'default'       => 'no',
                'class'         => 'la-radio-style',
                'title'         => esc_html_x('Enable Custom Style', 'admin-view', 'pisces'),
                'options'       => Pisces_Options::get_config_radio_opts(false),
                'dependency'    => array( 'page_title_bar_layout', '!=', 'hide' )
            ),
            ...
            array(
                ...
                'desc'          => esc_html_x('For page title bar', 'admin-view', 'pisces'),
