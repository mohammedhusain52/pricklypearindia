...
if(!function_exists('pisces_entry_meta_item_postdate')){
    function pisces_entry_meta_item_postdate(){
        ...
        printf(
            '<span class="posted-on"><a href="%1$s" rel="bookmark"><i class="fa-clock-o"></i><span class="screen-reader-text">%2$s </span>%3$s</a></span>',
            esc_url( get_permalink() ),
            esc_html_x('Posted on', 'front-view', 'pisces'),
            $time_string
        );
    }
}
if(!function_exists('pisces_entry_meta_item_author')){
    function pisces_entry_meta_item_author(){
        printf(
            '<span class="byline"><span class="author vcard"><a class="url fn n" href="%1$s"><i class="fa-user-o"></i><span class="screen-reader-text">%2$s </span>%3$s</a></span></span>',
            esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
            esc_html_x('by', 'front-view', 'pisces'),
            esc_html( get_the_author() )
        );
    }
}
if(!function_exists('pisces_entry_meta_item_category_list')){
    function pisces_entry_meta_item_category_list($before = '', $after = '', $separator = ', ', $parents = '', $post_id = false){
        ...
        if ( $categories_list ) {
            printf(
                ...
                esc_html_x('Posted in', 'front-view', 'pisces'),
...
if(!function_exists('pisces_exclude_demo_term_in_category')){
    function pisces_exclude_demo_term_in_category( $term ){
        return apply_filters('pisces/post_category_excluded', $term);
    }
}

if(!function_exists('pisces_entry_meta_item_comment_post_link')){
    function pisces_entry_meta_item_comment_post_link(){
...
if(!function_exists('pisces_entry_meta_item_comment_post_link_with_icon')){
    function pisces_entry_meta_item_comment_post_link_with_icon(){
        if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
            if(get_comments_number()){

            }
            echo '<span class="comments-link">';
            comments_popup_link('<i class="fa-comments"></i><span>0</span>', '<i class="fa-comments"></i><span>1</span>', '<i class="fa-comments"></i><span>%</span>');
            echo '</span>';
        }
    }
}

if(!function_exists('pisces_entry_meta_item_post_love')) {
    function pisces_entry_meta_item_post_love()
    {
...
if(!function_exists('pisces_single_post_thumbnail')){
    function pisces_single_post_thumbnail( $thumbnail_size = 'full'){
        ...
        switch(get_post_format()){
            case 'link':
                ...
                if(!empty($link)){
                    printf(
                        ...
                        esc_url($link),
                        has_post_thumbnail() ? 'style="background-image:url('.Pisces()->images->get_post_thumbnail_url(get_the_ID()).')"' : ''
                    );
            ...
            case 'audio':
            case 'video':
                $embed_source = Pisces()->settings->get_post_meta(get_the_ID(), 'format_embed');
                $embed_aspect_ration = Pisces()->settings->get_post_meta(get_the_ID(), 'format_embed_aspect_ration');
...
if(!function_exists('pisces_social_sharing')){
    function pisces_social_sharing( $post_link = '', $post_title = '', $image = '', $post_excerpt = '', $echo = true){
        ...
        if(Pisces()->settings->get('sharing_facebook') || 'on' == Pisces()->settings->get('sharing_facebook')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="facebook" title="%2$s"><i class="fa fa-facebook"></i></a>',
                ...
                esc_attr_x('Share this post on Facebook', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_twitter') || 'on' == Pisces()->settings->get('sharing_twitter')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="twitter" title="%2$s"><i class="fa fa-twitter"></i></a>',
                ...
                esc_attr_x('Share this post on Twitter', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_reddit') || 'on' == Pisces()->settings->get('sharing_reddit')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="reddit" title="%2$s"><i class="fa fa-reddit"></i></a>',
                ...
                esc_attr_x('Share this post on Reddit', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_linkedin') || 'on' == Pisces()->settings->get('sharing_linkedin')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="linkedin" title="%2$s"><i class="fa fa-linkedin"></i></a>',
                ...
                esc_attr_x('Share this post on Linked In', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_google_plus') || 'on' == Pisces()->settings->get('sharing_google_plus')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="google-plus" title="%2$s"><i class="fa fa-google-plus"></i></a>',
                ...
                esc_attr_x('Share this post on Google Plus', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_tumblr') || 'on' == Pisces()->settings->get('sharing_tumblr')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="tumblr" title="%2$s"><i class="fa fa-tumblr"></i></a>',
                ...
                esc_attr_x('Share this post on Tumblr', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_pinterest') || 'on' == Pisces()->settings->get('sharing_pinterest')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="pinterest" title="%2$s"><i class="fa fa-pinterest-p"></i></a>',
                ...
                esc_attr_x('Share this post on Pinterest', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_vk') || 'on' == Pisces()->settings->get('sharing_vk')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="vk" title="%2$s"><i class="fa fa-vk"></i></a>',
                ...
                esc_attr_x('Share this post on VK', 'front-view', 'pisces')
            );
        }
        if(Pisces()->settings->get('sharing_email') || 'on' == Pisces()->settings->get('sharing_email')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="email" title="%2$s"><i class="fa fa-envelope"></i></a>',
                ...
                esc_attr_x('Share this post via Email', 'front-view', 'pisces')
            );
        }
        echo '</div>';
        if(!$echo){
...
if(!function_exists('pisces_the_pagination')){
    function pisces_the_pagination($args = array(), $query = null) {
        if(null === $query) {
        ...
        printf('<div class="la-pagination">%s</div>',
            paginate_links(array_merge(array(
                ...
                'prev_text'    => esc_html_x('Prev', 'front-view', 'pisces'),
                'next_text'    => esc_html_x('Next', 'front-view', 'pisces'),
                'type'         => 'list'
            ), $args))
        );
    }
...
if(!function_exists('pisces_get_social_media')){
    function pisces_get_social_media( $style = 'default', $el_class = ''){
...
if(!function_exists('pisces_get_portfolio_social_media')){
    function pisces_get_portfolio_social_media($post_id = 0, $el_class = ''){

        $css_class = 'social--sharing ' . $el_class;

        $social_links = Pisces()->settings->get_post_meta($post_id,'social_links');
...
if(!function_exists('pisces_comment_form_callback')) {
    function pisces_comment_form_callback($comment, $args, $depth){
...
if(!function_exists('pisces_get_total_post_favorite')){
    function pisces_get_favorite_number_by_post_id( $post_id = 0 ){
        if(empty($post_id)){
            $post_id = get_the_ID();
        }
        return (int) get_post_meta( $post_id, 'la_total_favorites', true);
    }
}

if(!function_exists('pisces_get_favorite_link')){
    function pisces_get_favorite_link( $post_id = 0 ){
        if(empty($post_id)){
            $post_id = get_the_ID();
        }
        $count = pisces_get_favorite_number_by_post_id( $post_id );
        $lists = Pisces()->favorite->get_favorite_lists();
        $class = '';
        if(in_array($post_id, $lists)){
            $class = 'added';
        }
        ?>
        <div class="la-favorite-link">
            <a class="<?php echo esc_attr($class); ?>" href="javascript:;" rel="nofollow" data-favorite_id="<?php echo esc_attr($post_id)?>"><i class="fa fa-thumbs-up"></i><span class="favorite_count"><?php echo esc_html($count); ?></span></a>
        </div>
    <?php
    }
}
