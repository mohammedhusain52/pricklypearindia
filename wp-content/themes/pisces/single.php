                        ...
                        <div class="single-post-detail clearfix">
                            ...
                            if( have_posts() ):  the_post(); ?>
                                ...
                                <article id="post-<?php the_ID(); ?>" <?php post_class('single-post-content'); ?>>
                                    ...
                                    <?php
                                        if(Pisces()->settings->get('blog_post_title') != 'above' && Pisces()->settings->get('blog_post_title') != 'below'){
                                            the_title( '<header class="entry-header single_post_item--title hidden"><h1 class="entry-title">', '</h1></header>' );
                                        }
                                    ?>

                                    <?php
                                    if('above' == Pisces()->settings->get('blog_post_title')){
                                        the_title( '<header class="entry-header single_post_item--title"><h1 class="entry-title h2">', '</h1></header>' );
                                    }
                                    ?>
                                    <?php
                                        if(Pisces()->settings->get('featured_images_single') == 'on'){
                                            pisces_single_post_thumbnail($single_post_thumbnail_size);
                                        }
                                    ?>
                                    <?php
                                        if('below' == Pisces()->settings->get('blog_post_title') ){
                                            the_title( '<header class="entry-header single_post_item--title"><h1 class="entry-title h2">', '</h1></header>' );
                                        }
                                    ?>
                                    ...
                                    <div class="single_post_item--meta blog_item--meta entry-meta clearfix"><?php
                                        ...
                                        pisces_entry_meta_item_category_list('<div class="blog_item--category-link single_post_item--category-link">','</div>','');
                                    ?></div><!-- .entry-meta -->
