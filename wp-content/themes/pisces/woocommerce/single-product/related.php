...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Pisces()->settings->get('related_products_columns')
	);
	...
	$title = Pisces()->settings->get('related_product_title') ? Pisces()->settings->get('related_product_title') : _x( 'Related Products', 'front-view', 'pisces' );
	$sub_title = Pisces()->settings->get('related_product_subtitle') ? Pisces()->settings->get('related_product_subtitle') : '';
	?>
