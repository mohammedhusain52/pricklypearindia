...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        Pisces()->settings->get('upsell_products_columns')
    );
    ...
    $title = Pisces()->settings->get('upsell_product_title') ? Pisces()->settings->get('upsell_product_title') : _x( 'You may also like&hellip;', 'front-view', 'pisces' );
    $sub_title = Pisces()->settings->get('upsell_product_subtitle') ? Pisces()->settings->get('upsell_product_subtitle') : '';
    ?>
