...
foreach ( $graph_lines_data as $line ) {
	$unit = ( '' !== $units ) ?  $line['value'] . $units : '';
	$output .= '<div class="vc_single_bar--outer">';
	$output .= '<div class="vc_label"' . $line['txtcolor'] . '>' . $line['label'] . '</div>';
	...
	$output .= '<span data-text="'. esc_attr($unit) .'" class="vc_bar ' . esc_attr( implode( ' ', $bar_options ) ) . '" data-percentage-value="' . esc_attr( $percentage_value ) . '" data-value="' . esc_attr( $line['value'] ) . '"' . $line['bgcolor'] . '></span>';
	$output .= '</div>';
	$output .= '</div>';
}
