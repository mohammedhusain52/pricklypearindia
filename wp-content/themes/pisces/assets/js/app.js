...
(function($) {
    ...
    LA_ProductGallery.prototype.initSlickslider = function() {
        ...
        $thumb.slick({
            ...
            arrows: true,
            focusOnSelect: true,
            prevArrow: '<span class="slick-prev"><span class="pisces-icon-arrow-minimal-left"></span></span>',
            nextArrow: '<span class="slick-next"><span class="pisces-icon-arrow-minimal-right"></span></span>',
...
(function($) {
    ...
    LA.ui.LazyLoadElementEffect = function( selector, $container ){
        ...
        var create_appear = function(){
            $container.appear();
            $container.on('appear', function(){
                if(false === !!$container.data('appear-success')){

                    var _effect_name = false === !!$container.data('la-effect') ? 'sequenceupfade' : $container.attr('data-la-effect');

                    LA.ui.AnimateLoadElement(_effect_name, $(selector, $container), function(){
                        $(selector, $container).addClass('showmenow');
                    });
                    $container.attr('data-appear-success', 'true');
                }
            });
        ...
        if($.isFunction( $.fn.appear )){
            ...
            LA.core.loadDependencies([ LA.core.path.plugins + 'jquery.appear.js'], create_appear );
        }
    ...
    LA.component.AjaxLoadShortCode = function(el){
        ...
        var init = function(){
            if($.isFunction( $.fn.appear )){
                ...
                LA.core.loadDependencies([ LA.core.path.plugins + 'jquery.appear.js'], setup_ajax );
            }
        };

        var setup_ajax = function(){
            $this.appear();
            $this.on('appear', function(e, $all_appeared_elements){
    ...
    LA.component.CountDownTimer = function(el){
        ...
        var init_CountDownTimer = function(){
            ...
            if(false === !!$shortcode.data('appear-success')){
                ...
                $shortcode.attr('data-appear-success','true');
            }
        };
    ...
    LA.component.AnimationBlock = function(el){
        ...
        var create_appear = function(){
            ...
            $shortcode.on('appear', function(){
                ...
                if(false !== !!$this.data('animate') && false === !!$this.data('appear-success')){
    ...
    LA.component.InstagramFeed = function(el){
        ...
        var init_feed = function(){
            ...
            if(false === !!$this.data('appear-success')){
                ...
                if(la_theme_config.security.instagram_token != ''){
                    var _tmp_user = la_theme_config.security.instagram_token.split('.');
    ...
    LA.core.MegaMenu = function(){
        ...
        function fix_megamenu_position( $elem, containerClass, container_width, isVerticalMenu) {
            ...
            if (!isVerticalMenu) {
                ...
                if(containerClass == 'body.pisces-body'){
                    ...
                    $('li.mm-popup-wide', _that).each(function(){
                        ...
                        if( $menu_item.hasClass('mm-popup-force-fullwidth')){
                            ...
                            if(!isVerticalMenu){
                                ...
                                _containerClass = 'body.pisces-body';
                            }else{
        ...
        var mobile_menu = function mobile_menu(){
            $mobile_nav.find('.sub-menu').addClass('dl-submenu');
            $mobile_nav.dlmenu({
    ...
    LA.core.HeaderSticky = function(){
        ...
        var prepareHeightForHeader = function (){
            ...
            if(winW > 992){
                if($.exists($masthead)){
                    if(winW > 1300){
                        $('.la-header-sticky-height').height( obj_height.desktop.normal );
                    }else{
                        $('.la-header-sticky-height').height( obj_height.tablet.normal );
                    }
                }
            }else{
                if($.exists($masthead_mb)){
                    $('.la-header-sticky-height-mb').height( obj_height.mobile.normal );
                }
            }
        }
    ...
    LA.core.WooCommerce = function(){
        ...
        $document.on('adding_to_cart', function( e ){
            ...
            $('.la_com_action--cart > a > i').removeClass('pisces-icon-cart-modern').addClass('fa-spinner fa-spin');
        });
        $document.on('added_to_cart', function( e, fragments, cart_hash, $button ){
            ...
            $('.la_com_action--cart > a > i').removeClass('fa-spinner fa-spin').addClass('pisces-icon-cart-modern');
        } );
        ...
        $document
            .on('click','.wc-view-toggle span',function(){
                ...
                if(!_this.hasClass('active')){
                    ...
                    Cookies.set('pisces_wc_catalog_view_mode', _mode, { expires: 30 });
                }
            });
...
(function($) {
    ...
    $(function(){
        ...
        if($.exists($('#demo_05_section_intro_row_2'))){
            var $demo_05_section_intro_row_2 = $('#demo_05_section_intro_row_2');
            $demo_05_section_intro_row_2.prepend('<svg><polygon id="demo_05_section_intro_row_2_triangle" points="" stroke="0"/><polygon id="demo_05_section_intro_row_3_triangle" points="" stroke="0"/></svg>');

            var demo5_draw_svg = function (){
                var a,b = 0;
                a = $demo_05_section_intro_row_2.innerWidth();
                b = $demo_05_section_intro_row_2.innerHeight() - parseInt($demo_05_section_intro_row_2.innerHeight()/4);
                $('#demo_05_section_intro_row_2_triangle').attr('points', a +','+ 0 +' '+ a + ','+ b + ' '+ 0 +','+ b +' ');

                var x1,x2,x3,x4 = '';
                x1 = '0,' + b;
                x2 = $demo_05_section_intro_row_2.innerWidth() + ',' + b;
                x3 = $demo_05_section_intro_row_2.innerWidth() + ',' + $demo_05_section_intro_row_2.innerHeight();
                x4 = '0,' + $demo_05_section_intro_row_2.innerHeight();
                $('#demo_05_section_intro_row_3_triangle').attr('points', x1 + ' ' + x2 + ' ' + x3 + ' ' + x4);
            };
            demo5_draw_svg();
            $(window).on('resize', function(){
                demo5_draw_svg();
                    ...
                    $('<img/>')
                        .on('load', function() {
                            ...
                            if(this.naturalWidth != "undefined" && this.naturalWidth != 0 && this.naturalHeight != "undefined" && this.naturalHeight != 0){
                                el_parallax.attr('data-bg-image', el_parallax_bg).attr('data-bg-height', this.naturalHeight).attr('data-bg-width', this.naturalWidth).appendTo($page_header);
                                LA.core.initAll($page_header);
                            }
                        })
                        .attr('src', el_parallax_bg);
                }
            }
        }
