...
if ( typeof _LaImageParallaxImages === 'undefined' ) {
    var _LaImageParallaxImages = [];
    var _LaScrollTop;
    var _LaWindowHeight;
    var _LaScrollLeft;
    var _LaWindowWidth;
...
function _LaRefreshScroll() {
    var $ = jQuery;
    _LaScrollTop = window.pageYOffset;//$(window).scrollTop();
    _LaScrollLeft = window.pageXOffset;//$(window).scrollLeft();
}

function _LaParallaxAll() {
    _LaRefreshScroll();
    for ( var i = 0; i < _LaImageParallaxImages.length; i++) {
        _LaImageParallaxImages[ i ].doParallax();
    }
}
...
jQuery(document).ready(function($) {
    ...
    $(window).on( 'grid:items:added la_vc_row_parallax:refresh', function() {
        setTimeout( function() {
            var $ = jQuery;
            _LaRefreshWindow();
            $.each( _LaImageParallaxImages, function( i, parallax ) {
    ...
    function _LaRefreshWindow() {
        _LaScrollTop = window.pageYOffset;//$(window).scrollTop();
        _LaWindowHeight = window.innerHeight;//$(window).height()
        _LaScrollLeft = window.pageXOffset;//$(window).scrollLeft();
        _LaWindowWidth = window.innerWidth;//$(window).width()
    }
});